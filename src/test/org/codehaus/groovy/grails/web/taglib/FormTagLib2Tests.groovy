...
class FormTagLib2Tests extends AbstractGrailsTagTests {
    ...
    private static final Collection DATE_PRECISIONS_INCLUDING_MINUTE = Collections.unmodifiableCollection(["minute", null])
    private static final Collection DATE_PRECISIONS_INCLUDING_HOUR = Collections.unmodifiableCollection(["hour", "minute", null])
    private static final Collection DATE_PRECISIONS_INCLUDING_DAY = Collections.unmodifiableCollection(["day", "hour", "minute", null])
    private static final Collection DATE_PRECISIONS_INCLUDING_MONTH = Collections.unmodifiableCollection(["month", "day", "hour", "minute", null])
