 ...
 * 
 * @author Graeme Rocher, Drew Varner
 *
 */
public class FindAllWherePersistentMethod extends AbstractStaticPersistentMethod {

	
	private static final String METHOD_PATTERN = "^findAllWhere$";

	public FindAllWherePersistentMethod(SessionFactory sessionFactory, ClassLoader classLoader) {
