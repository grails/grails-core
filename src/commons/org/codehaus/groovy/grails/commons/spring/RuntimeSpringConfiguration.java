 ...
 * Copyright 2004-2005 the original author or authors.
                    ...
                    public interface RuntimeSpringConfiguration extends ServletContextAware {
                        ...
                        /**
                         * Creates all of the BeanDefinition instances for the current state of this runtime configuration
                         *
                         * @return An map of bean definitions with the bean name as the key
                         */
                        Map createBeanDefinitions();
                    }
