...
class MinConstraint extends AbstractConstraint {
    ...
    public void setParameter(Object constraintParameter) {
        ...
        Class propertyClass = GrailsClassUtils.getProperyType( constraintOwningClass, constraintPropertyName );
    ...
    protected void processValidate(Object target, Object propertyValue, Errors errors)		{
        ...
        if(minValue.compareTo(propertyValue) > 0) {
            ...
            super.rejectValue(errors,ConstrainedProperty.MIN_CONSTRAINT + ConstrainedProperty.NOTMET_SUFFIX,args,getDefaultMessage(ConstrainedProperty.DEFAULT_INVALID_MIN_MESSAGE_CODE, args));
        }
    }
}
