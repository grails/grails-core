    ...
    protected void processValidate(Object target, Object propertyValue, Errors errors) {
        ...
        if(creditCard) {
            ...
            if(!validator.isValid(propertyValue.toString())  ) {
                ...
                super.rejectValue(errors,ConstrainedProperty.CREDIT_CARD_CONSTRAINT + ConstrainedProperty.INVALID_SUFFIX,args,getDefaultMessage(ConstrainedProperty.DEFAULT_INVALID_CREDIT_CARD_MESSAGE_CODE, args));
            }
        }
    }
