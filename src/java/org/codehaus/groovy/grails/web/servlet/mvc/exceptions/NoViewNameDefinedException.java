...
public class NoViewNameDefinedException extends GrailsMVCException {
    ...
    public NoViewNameDefinedException(String message) {
        super(message);
    }

    public NoViewNameDefinedException(String message, Throwable cause) {
        super(message, cause);
    }

    public NoViewNameDefinedException(Throwable cause) {
        super(cause);
    }
}
