...
class DefaultGrailsDomainClassProperty extends org.grails.core.DefaultGrailsDomainClassProperty {
    ...
    DefaultGrailsDomainClassProperty(grails.core.GrailsDomainClass domainClass, PropertyDescriptor descriptor, Map<String, Object> defaultConstraints) {
        super(domainClass, descriptor, defaultConstraints)
    }
}
