...
<html>
    <head>
         ...
         <title>Create AccessKey</title>
         <link rel="stylesheet" href="${createLinkTo(dir:'css',file:'main.css')}"></link>
    </head>
    <body>
        <div class="body">
           <h1>Create AccessKey</h1>
           ...
           <g:form action="save" method="post">
               <div class="dialog">
                <table>
								  ...
								  <tr class='prop'><td valign='top' style='text-align:left;' width='20%'><label for='role'>Site:</label></td><td valign='top' style='text-align:left;' width='80%' class='${hasErrors(bean:accessKey,field:'site','errors')}'><g:select optionKey="id" from="${Site.list()}" name='site.id' value='${accessKey?.site?.id}'></g:select></td></tr>
