...
public class ASTBeanPropertyBindingResultHelper implements ASTErrorsHelper {
    ...
    protected void addErrorsField(final ClassNode paramTypeClassNode) {
        final FieldNode errorsField = paramTypeClassNode.getField("errors");
        if(errorsField == null) {
    ...
    protected void addClearErrorsMethod(final ClassNode paramTypeClassNode) {
        final MethodNode clearErrorsMethod = paramTypeClassNode.getMethod("clearErrors", ZERO_PARAMETERS);
    ...
    protected void addHasErrorsMethod(final ClassNode paramTypeClassNode) {
        final MethodNode getErrorsMethod = paramTypeClassNode.getMethod("hasErrors", ZERO_PARAMETERS);
        if (getErrorsMethod == null) {
            ...
            final ReturnStatement returnStatement = new ReturnStatement(new BooleanExpression(new MethodCallExpression(new VariableExpression("errors"), "hasErrors", EMPTY_TUPLE)));
    ...
    protected void addGetErrorsMethod(final ClassNode paramTypeClassNode) {
        final MethodNode getErrorsMethod = paramTypeClassNode.getMethod("getErrors", ZERO_PARAMETERS);
        if (getErrorsMethod == null) {
            ...
            final ReturnStatement returnStatement = new ReturnStatement(new VariableExpression("errors"));
    ...
    protected void addSetErrorsMethod(final ClassNode paramTypeClassNode) {
        ...
        if(setErrorsMethod == null) {
            final BinaryExpression assignErrorsExpression = new BinaryExpression(new VariableExpression("errors"),
