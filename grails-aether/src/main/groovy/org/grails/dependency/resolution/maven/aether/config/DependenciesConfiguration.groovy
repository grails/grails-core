...
class DependenciesConfiguration {
    ...
    void addDependency(org.grails.dependency.resolution.Dependency dependency, String scope) {
        dependencyManager.addDependency dependency, scope, exclusionDependencySelector
    }

    void addBuildDependency(org.grails.dependency.resolution.Dependency dependency) {
