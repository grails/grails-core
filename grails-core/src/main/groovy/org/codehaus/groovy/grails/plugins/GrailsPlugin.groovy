 ...
 * @deprecated Use {@link grails.plugins.GrailsPlugin} instead
 */
@Deprecated
public interface GrailsPlugin {
     ...
     */
    grails.plugins.GrailsPluginManager getManager();
     ...
     */
    void setManager(grails.plugins.GrailsPluginManager manager);
