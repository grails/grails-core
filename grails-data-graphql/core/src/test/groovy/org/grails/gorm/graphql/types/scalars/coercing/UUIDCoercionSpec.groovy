...
class UUIDCoercionSpec extends Specification {

    UUIDCoercion coercion = new UUIDCoercion()

    void "test serialize with a UUID instance"() {
        given:
    ...
    void "test parseValue with a UUID instance"() {
        given:
        UUID uuid = UUID.randomUUID()
