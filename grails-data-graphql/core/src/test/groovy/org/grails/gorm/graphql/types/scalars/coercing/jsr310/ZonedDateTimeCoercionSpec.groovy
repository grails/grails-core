...
class ZonedDateTimeCoercionSpec extends Specification {

    ZonedDateTimeCoercion coercion = new ZonedDateTimeCoercion(["yyyy-MM-dd'T'HH:mm:ssXXX"])

    void "test serialize with a ZonedDateTime instance"() {
        given:
    ...
    void "test parseValue with a ZonedDateTime instance"() {
        given:
        ZonedDateTime dateTime = ZonedDateTime.of(2020, 1, 15, 10, 15, 30, 0, ZoneOffset.ofHours(2))
