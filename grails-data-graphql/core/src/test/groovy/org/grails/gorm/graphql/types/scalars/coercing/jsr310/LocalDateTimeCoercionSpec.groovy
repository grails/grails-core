...
class LocalDateTimeCoercionSpec extends Specification {

    LocalDateTimeCoercion coercion = new LocalDateTimeCoercion(['yyyy-MM-dd HH:mm:ss'])

    void "test serialize with a LocalDateTime instance"() {
        given:
    ...
    void "test parseValue with a LocalDateTime instance"() {
        given:
        LocalDateTime dateTime = LocalDateTime.of(2020, 1, 15, 10, 15, 30)
