...
class URLCoercionSpec extends Specification {

    URLCoercion coercion = new URLCoercion()

    void "test serialize with a URL instance"() {
        given:
    ...
    void "test parseValue with a URL instance"() {
        given:
        URL url = new URL('https://grails.apache.org')
