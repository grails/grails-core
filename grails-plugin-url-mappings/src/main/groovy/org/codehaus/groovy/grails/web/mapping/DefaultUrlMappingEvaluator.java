...
public class DefaultUrlMappingEvaluator implements UrlMappingEvaluator, ClassLoaderAware, PluginManagerAware {
    ...
    class UrlMappingBuilder extends GroovyObjectSupport {
                ...
                try {
                    ...
                    if (args[0] instanceof Closure) {
                        ...
                        if (uri != null) {
                            ...
                            urlMapping = createURLMapping(urlData, isResponseCode, controllerName, actionName, namespace, pluginName, viewName, httpMethod, constraints);
                        }
                    ...
                    if (args[0] instanceof Map) {
                        ...
                        if (namedArguments.containsKey(RESOURCE)) {
                            ...
                            if (controller != null) {
                                ...
                                createSingleResourceRestfulMappings(controllerName, pluginName, urlData, getCurrentConstraints(), calculateIncludes(namedArguments, DEFAULT_RESOURCE_INCLUDES));
                            }
                            ...
                            if (controller != null) {
                                createResourceRestfulMappings(controllerName, pluginName, urlData, getCurrentConstraints(), calculateIncludes(namedArguments, DEFAULT_RESOURCES_INCLUDES));
                            }
                        } else {
        ...
        protected UrlMapping createEditActionResourcesRestfulMapping(String controllerName, Object pluginName, UrlMappingData urlData, List<ConstrainedProperty> previousConstraints) {
            ...
            return new RegexUrlMapping(editUrlMappingData,controllerName, ACTION_EDIT,null, pluginName, null, HttpMethod.GET.toString(), editUrlMappingConstraints.toArray(new ConstrainedProperty[editUrlMappingConstraints.size()]) , servletContext);
        }
        ...
        private UrlMapping getURLMappingForNamedArgs(Map namedArguments,
            ...
            if (uri != null) {
                ...
                urlMapping = createURLMapping(urlData, isResponseCode, controllerName, actionName, namespace, pluginName, viewName, httpMethod != null ? httpMethod.toString() : null, constraints);
            }
        ...
        private UrlMapping createURLMapping(UrlMappingData urlData, boolean isResponseCode,
            ...
            if (!isResponseCode) {
                return new RegexUrlMapping(urlData, controllerName, actionName, namespace, pluginName, viewName, httpMethod,
                        constraints, sc);
            }
