...
interface GrailsTestType {
     ...
     *
     * If the value returned is less than 1, {@link #run(org.grails.test.event.GrailsTestEventPublisher)} will NOT be called.
     *
    ...
    /**
     * Runs the tests, appropriately calls {@link org.grails.test.event.GrailsTestEventPublisher eventPublisher} and
