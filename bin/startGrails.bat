...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\groovy-all-1.7.3.jar;%GRAILS_HOME%\dist\grails-bootstrap-1.3.4.BUILD-SNAPSHOT.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version="1.3.4.BUILD-SNAPSHOT"
