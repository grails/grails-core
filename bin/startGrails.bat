...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\groovy-all-1.6.7.jar;%GRAILS_HOME%\dist\grails-bootstrap-1.3.0.BUILD-SNAPSHOT.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version="1.3.0.BUILD-SNAPSHOT"
