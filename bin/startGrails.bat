...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\groovy-all-1.7.1.jar;%GRAILS_HOME%\dist\grails-bootstrap-1.3.0.RC1.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version="1.3.0.RC1"
