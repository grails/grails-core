...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\groovy-all-1.6.8.jar;%GRAILS_HOME%\dist\grails-bootstrap-1.2.2.BUILD-SNAPSHOT.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version="1.2.2.BUILD-SNAPSHOT
