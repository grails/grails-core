 ...
 * @since 2.3.1
 */
public interface DataBindingListener2 extends DataBindingListener {
     ...
     */
    Boolean beforeBinding(Object target, BindingResult errors);
     ...
     * @param target The object data binding is being imposed upon
     */
    void afterBinding(Object target, BindingResult errors);
}
