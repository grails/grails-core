...
public class GroovyPagesTemplateRenderer implements InitializingBean{
	...
	private Template generateScaffoldedTemplate(GrailsWebRequest webRequest,
		...
		Template t=null;
		Collection<String> controllerActions = (Collection<String>)scaffoldedActionMap.get(webRequest.getControllerName());
		if (controllerActions != null && controllerActions.contains(webRequest.getActionName())) {
		    GrailsDomainClass domainClass = (GrailsDomainClass)controllerToScaffoldedDomainClassMap.get(webRequest.getControllerName());
		    if (domainClass != null) {
	...
	public void setGroovyPageLocator(
			GrailsConventionGroovyPageLocator groovyPageLocator) {
		this.groovyPageLocator = groovyPageLocator;
	}

	public void setGroovyPagesTemplateEngine(
			GroovyPagesTemplateEngine groovyPagesTemplateEngine) {
		this.groovyPagesTemplateEngine = groovyPagesTemplateEngine;
	}

	public void setScaffoldingTemplateGenerator(Object scaffoldingTemplateGenerator) {
		this.scaffoldingTemplateGenerator = scaffoldingTemplateGenerator;
	}
	...
	public void setControllerToScaffoldedDomainClassMap(
			Map controllerToScaffoldedDomainClassMap) {
		this.controllerToScaffoldedDomainClassMap = controllerToScaffoldedDomainClassMap;
	}
