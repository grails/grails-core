...
class IncludeExcludeBindingSpec extends Specification {
    ...
    void 'Test white list'() {
        ...
        when:
        binder.bind greek, [alpha: 1, beta: 2, gamma: 3, delta: 4], whiteList
    ...
    void 'Test black list'() {
        ...
        when:
        binder.bind greek, [alpha: 1, beta: 2, gamma: 3, delta: 4], null, blackList
    ...
    void 'Test black list overrules white list'() {
        ...
        when:
        binder.bind greek, [alpha: 1, beta: 2, gamma: 3, delta: 4], whiteList, blackList
