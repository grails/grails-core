...
public class GrailsCoreDependencies {
    ...
    protected final String groovyVersion = System.getenv("CI_GROOVY_VERSION") != null ? System.getenv("CI_GROOVY_VERSION") : "2.4.3-SNAPSHOT";
    protected final String springVersion = "4.1.5.RELEASE";
