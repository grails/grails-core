...
public class GrailsCoreDependencies {
    ...
    protected final String groovyVersion = System.getenv("CI_GROOVY_VERSION") != null ? System.getenv("CI_GROOVY_VERSION") : "2.3.11";
    protected final String springVersion = "4.0.9.RELEASE";
