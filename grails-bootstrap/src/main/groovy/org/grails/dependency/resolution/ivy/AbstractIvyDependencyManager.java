 ...
 */
package org.grails.dependency.resolution.ivy;
...
import org.grails.dependency.resolution.ivy.config.DependencyConfigurationConfigurer;
import org.grails.dependency.resolution.ivy.config.DependencyConfigurationContext;
import org.grails.dependency.resolution.ivy.maven.PomModuleDescriptorParser;
...
public abstract class AbstractIvyDependencyManager {
    ...
    public AbstractIvyDependencyManager(IvySettings ivySettings, BuildSettings buildSettings, Metadata metadata) {
        ...
        ModuleDescriptorParserRegistry.getInstance().addParser(PomModuleDescriptorParser.getInstance());
