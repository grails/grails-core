...
""")
	...
	void testServicesPlugin() {
		...
		def hibernatePluginClass = gcl.loadClass("org.codehaus.groovy.grails.orm.hibernate.plugins.HibernateGrailsPlugin")
		...
		def pluginClass = gcl.loadClass("org.codehaus.groovy.grails.services.plugins.ServicesGrailsPlugin")
