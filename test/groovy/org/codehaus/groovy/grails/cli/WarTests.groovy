...
class WarTests  extends AbstractCliTests {
	...
	void testWAR() {
		...
		assert new File("${appBase}/unzipped/WEB-INF/plugins/core/grails-app/taglib/ApplicationTagLib.groovy").exists()
		assert new File("${appBase}/unzipped/WEB-INF/plugins/core/grails-app/taglib/FormTagLib.groovy").exists()
		assert new File("${appBase}/unzipped/WEB-INF/plugins/core/grails-app/taglib/JavascriptTagLib.groovy").exists()
		assert new File("${appBase}/unzipped/WEB-INF/plugins/core/grails-app/taglib/RenderTagLib.groovy").exists()
		assert new File("${appBase}/unzipped/WEB-INF/plugins/core/grails-app/taglib/UITagLib.groovy").exists()
		assert new File("${appBase}/unzipped/WEB-INF/plugins/core/grails-app/taglib/ValidationTagLib.groovy").exists()
