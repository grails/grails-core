...
public class RenderInputTests  extends TestCase {
    ...
    public void testBooleanTemplate() throws Exception {
        ...
        Template template = templateEngine.createTemplate(new File("src/war/WEB-INF/internal/render/java.lang.Boolean.gsp"));
        Map binding = new HashMap();

        binding.put("name", "testBoolean");
        binding.put("value", Boolean.TRUE);
        binding.put("constraints", null);
        ...
        binding.put("value", Boolean.FALSE);
        xml = DocumentHelper.parseText(template.make(binding).toString());
    ...
    public void testDateTemplate() throws Exception {
        ...
        Template template = templateEngine.createTemplate(new File("src/war/WEB-INF/internal/render/java.util.Date.gsp"));
        Map binding = new HashMap();
    ...
    public void testLocaleTemplate() throws Exception {
        ...
        Template template = templateEngine.createTemplate(new File("src/war/WEB-INF/internal/render/java.util.Locale.gsp"));
        Map binding = new HashMap();
    ...
    public void testTimeZoneTemplate() throws Exception {
        ...
        Template template = templateEngine.createTemplate(new File("src/war/WEB-INF/internal/render/java.util.TimeZone.gsp"));
        Map binding = new HashMap();
    ...
    public void testCurrencyTemplate() throws Exception {
        ...
        Template template = templateEngine.createTemplate(new File("src/war/WEB-INF/internal/render/java.util.Currency.gsp"));
        Map binding = new HashMap();
    ...
    public void testNumberTemplate() throws Exception {
        ...
        Template template = templateEngine.createTemplate(new File("src/war/WEB-INF/internal/render/java.lang.Number.gsp"));
        Map binding = new HashMap();
