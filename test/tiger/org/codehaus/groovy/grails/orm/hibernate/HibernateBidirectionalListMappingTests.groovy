...
* Created: Mar 10, 2008
*/
class HibernateBidirectionalListMappingTests extends GroovyTestCase{
    ...
    protected void setUp() {
        ...
        config.addPackage "org.codehaus.groovy.grails.orm.hibernate"
        config.addAnnotatedClass FaqSection
        config.addAnnotatedClass FaqElement
    ...
    void testIndexBackrefMapping() {
        PersistentClass faqSection = config.getClassMapping(FaqSection.getName())
        PersistentClass faqElement = config.getClassMapping(FaqElement.getName())
        ...
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqSection.elements",  elementsIndexBackref.getCollectionRole()
        assertEquals 1, elementsIndexBackref.getColumnSpan()
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqSection",  elementsIndexBackref.getEntityName()
    ...
    void testCollectionBackrefMapping() {
        PersistentClass faqSection = config.getClassMapping(FaqSection.getName())
        PersistentClass faqElement = config.getClassMapping(FaqElement.getName())
        Backref elementsBackref =faqElement.getProperty("_elementsBackref")
        ...
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqSection.elements", elementsBackref.getCollectionRole()
        assertEquals 1, elementsBackref.getColumnSpan()
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqSection", elementsBackref.getEntityName()
        assertEquals PropertyGeneration.NEVER, elementsBackref.getGeneration()
        assertEquals "_elementsBackref", elementsBackref.getName()
        assertNull elementsBackref.getNodeName()
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqElement", elementsBackref.getPersistentClass().getClassName()
    ...
    void testManyToOneMapping() {
        ...
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqSection", manyToOne.getReferencedEntityName()
        assertNull manyToOne.getReferencedPropertyName()
        assertEquals ManyToOneType, manyToOne.getType().getClass()
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqSection", manyToOne.getTypeName()
    }
    ...
    void testListMapping() {
        ...
        List list = config.getCollectionMapping("org.codehaus.groovy.grails.orm.hibernate.FaqSection.elements")
...
//        assertEquals FaqElement,list.getCollectionPersisterClass()
        ...
        assertEquals "org.codehaus.groovy.grails.orm.hibernate.FaqSection.elements", list.getCacheRegionName()
        ...
        assertEquals "pos", indexColumn.getCanonicalName()
        assertNull indexColumn.getCheckConstraint()
        assertNull indexColumn.getComment()
        assertNull indexColumn.getDefaultValue()
        assertEquals 0, indexColumn.getLength()
        assertEquals "pos", indexColumn.getName()
        assertEquals 19, indexColumn.getPrecision()
        assertEquals "pos", indexColumn.getQuotedName()
        assertEquals 2, indexColumn.getScale()
        assertEquals "pos", indexColumn.getText()
        ...
        assertEquals FaqElement.getName(), associatedClass.getClassName()
