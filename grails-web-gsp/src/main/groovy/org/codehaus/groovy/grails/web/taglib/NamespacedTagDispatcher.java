...
public class NamespacedTagDispatcher extends GroovyObjectSupport {
    ...
    public NamespacedTagDispatcher(String ns, Class callingType, GrailsApplication application, TagLibraryLookup lookup) {
        this.namespace = ns;
    ...
    public Object methodMissing(String name, Object args) {
        return GroovyPagesMetaUtils.methodMissingForTagLib(getMetaClass(), type, lookup, namespace, name, args, !developmentMode);
    }
}
